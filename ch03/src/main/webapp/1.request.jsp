...
<!-- 
	...
	request 내장객체
	 ...
	 - 전송데이터는 주소에 노출되지 않고 요청 메시지 바디에 삽입되어 전송
	 - GET 방식에 비해 보안에 유리하고 대량의 데이터 전송에 적합
	 - 
 -->
</head>
<body>
	...
	<form action="./proc/result3.jsp" method="post">
		<table border="1">
			...
			<tr>
				<td>비밀번호</td>
				<td><input type="password" name="psw" placeholder="비밀번호입력"/></td>
			</tr>
			<tr>
				<td>이름</td>
			...
			<tr>
				<td>생년월일</td>
				<td><input type="date" name="birth" placeholder="이름입력"/></td>
			</tr>
			<tr>
				<td>성별</td>
