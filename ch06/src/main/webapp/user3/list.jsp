...
window.onload = function(){
	...
	// 고전 문서객체 선택함수(getElement~)는 forEach지원하지 않음
	...
	<table border="1">
		...
		<tr>
			...
			<td>
				...
				<a href="/ch06/user3/delete.jsp?uid=<%=vo.getUid()%>" class="delete">삭제</a>
			</td>
		</tr>
		<% } %>
	</table>
